...
import { SiteContext } from 'E:/组件库/node_modules/dumi/dist/client/theme-api/context.js';
...
export default function DumiContextWrapper() {
  ...
  return (
    <SiteContext.Provider value={{
      pkg: {"name":"zzc","description":"","version":"1.0.1","license":"MIT","repository":{"type":"git","url":"git+https://github.com/zhangrenyang/ant.git"},"author":"aaa"},
      entryExports,
      demos,
      components,
      locales,
